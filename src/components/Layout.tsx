...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-bg-main text-slate-200 font-sans">
      {/* Navigation */}
      ...
      <main className="px-6 md:px-12 lg:px-20 py-12 w-full max-w-[1920px] mx-auto min-h-[calc(100vh-64px)]">
        {children}
      </main>
    </div>
  );
