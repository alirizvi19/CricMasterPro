    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white italic">User Profile</h1>
            <p className="text-text-dim font-medium">Manage your personal information and presence</p>
          </div>
        </div>
      </header>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-bg-secondary border border-white/5 rounded-[2.5rem] p-8 text-center space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSave} className="bg-bg-secondary border border-white/5 rounded-[2.5rem] p-8 md:p-12 space-y-8 shadow-2xl">
