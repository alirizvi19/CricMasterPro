  ...
  return (
    <div className="space-y-12">
      <header className="space-y-4">
        <h1 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter text-white underline decoration- brand/20">Public <br /> <span className="text-brand">Tournaments</span></h1>
